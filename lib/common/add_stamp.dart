                            ...
                            children: [
                              ...
                              Center(
                                child: Center(
                                  child: Padding(
                                    ...
                                    child: Container(
                                        height:
                                            MyHelperFunctions.screenHeight() *
                                                0.22,
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: conversionType == 'add stamp'
                                          ? "Enter stamp text"
                                          : 'Enter custom text',
                              ...
                              if (conversionType == 'add stamp')
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                        hintText: "Enter opacity of stamp text",
                                        hintStyle:
                                            TextStyle(color: Colors.grey),
                                        focusedBorder: OutlineInputBorder(
                                            borderSide: BorderSide(
                              ...
                              Center(
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      String? filePath = filePickerController
                                    ...
                                    child: Text(conversionType == 'add stamp'
                                        ? "Add Stamp"
                                        : "Add Page Number")),
                              )
                            ]),
